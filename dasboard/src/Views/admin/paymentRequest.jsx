    ...
    return (
      <div style={style} className="flex text-sm">
        ...
        <div className="w-[20%] p-2 whitespace-nowrap">
          <span className="py-[1px] px-[5px] bg-slate-700 text-blue-500">
            Pending
          </span>
        </div>
    ...
    <div className="px-2 lg:px-7 pt-5">
        <div className="w-full p-4 bg-[#283046] rounded-md text-[#d0d2d6]">
          ...
          <div className=" w-full overflow-x-auto">
            <div className="bg-[#161d31] w-min-[340px] justify-between items-start flex uppercase text-xs font-bold">
