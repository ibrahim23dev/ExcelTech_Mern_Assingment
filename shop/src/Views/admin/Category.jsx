      ...
      <div className='flex flex-warp w-full'>
                    ...
                    [1, 2, 3, 4, 5].map((d, i) => <tr key={i}>
                      ...
                      <td className="py-3 px-6 font-medium whitespace-nowrap">
                        <div className='items-center gap-4 justify-start flex'>
                          <Link className='px-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'><FaEdit/></Link>
                          <Link className='px-[6px] bg-red-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'><FaTrash/></Link>
        ...
        <div className='w-full pl-5'>
            ...
            <form>
              ...
              <label className='  text-[#d0d2d6] mb-3 mt-2 gap-1 flex' htmlFor='name'>Category Name</label>
              ...
              <div>
                <label className='flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed hover:border-indigo-500 w-full border-[#d0d2d6]' htmlFor='image'>
                  <span className='text-[d0d2d6]'><BsImage className='text-[#d0d2d6]'/></span>
